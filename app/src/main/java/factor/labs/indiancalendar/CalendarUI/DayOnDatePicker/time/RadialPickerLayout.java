...
import factor.labs.indiancalendar.CalendarUI.DayOnDatePicker.Utils;
import factor.labs.indiancalendar.CalendarUI.DayOnDatePicker.animation.AnimatorSet;
    ...
    public void setCurrentItemShowing(int index, boolean animate) {
        ...
        if (animate && (index != lastIndex)) {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                float hourAlpha = (index == HOUR_INDEX) ? 255 : 0;
                float minuteAlpha = (index == MINUTE_INDEX) ? 255 : 0;
