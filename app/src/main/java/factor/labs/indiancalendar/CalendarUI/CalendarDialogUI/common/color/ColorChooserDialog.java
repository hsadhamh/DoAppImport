package factor.labs.indiancalendar.CalendarUI.CalendarDialogUI.common.color;
...
import factor.labs.indiancalendar.CalendarUI.CalendarDialogUI.core.DialogAction;
...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mGrid = new GridView(this.getContext());
    ...
    public ColorChooserDialog show(AppCompatActivity context) {
        show(context.getFragmentManager(), "[MD_COLOR_CHOOSER]");
        return this;
    }
}
