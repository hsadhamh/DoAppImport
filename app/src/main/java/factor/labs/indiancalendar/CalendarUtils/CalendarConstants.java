...
public class CalendarConstants {
    ...
    public final static String DAYON_SHARED_PREFERENCE_NAME = "Preference_Events";
    public final static String DAYON_TIME_REMINDER_HOLIDAY = "Reminder_Time_Holiday";
    public final static String DAYON_TIME_REMINDER_RELIGIOUS = "Reminder_Time_Religious";
    public final static String DAYON_TIME_REMINDER_HOLIDAY_ENABLE = "Enable_Reminder_Time_Holiday";
    public final static String DAYON_TIME_REMINDER_RELIGIOUS_ENABLE = "Enable_Reminder_Time_Religious";
