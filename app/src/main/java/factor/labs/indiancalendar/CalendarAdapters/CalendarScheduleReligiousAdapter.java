 ...
 */
public class CalendarScheduleReligiousAdapter extends BaseAdapter {
    ...
    public CalendarScheduleReligiousAdapter(List<CalendarListObjectClass> oDateGrid,
    ...
    public View getEventView(ViewGroup parent, CalendarEventMaster oEvent) {
        ...
        try {
            ...
            oHolder.oVw1 = (ImageView) v.findViewById(R.id.calendar_religion_img);
            ...
            int nReligionID = oEvent.getReligionID();
            if(nReligionID != 0) {
                oHolder.oVw1.setImageDrawable(mContext.getResources().getDrawable(labsCalendarUtils.getIconFormReligion(nReligionID)));
                oHolder.oVw1.setAlpha((float) 0.55);
            }
